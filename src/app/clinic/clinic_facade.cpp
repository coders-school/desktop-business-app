...
{
    return std::find_if(doctors_.begin(), doctors_.end(), [&new_doctor_pesel](const std::shared_ptr<Doctor>&exist_doctors){
...
{
    return std::find_if(receptionists_.begin(), receptionists_.end(), [&new_receptionist_pesel](const std::shared_ptr<Receptionist>&exist_receptionists){
