...
class Doctor : public Person
{
    ...
    Doctor(const std::string& name, const std::string& surname, const std::string& pesel);
  ...
  public:
    ...
    static std::shared_ptr<Doctor>& getDoctor(const std::string& name, const std::string& surname);
};
